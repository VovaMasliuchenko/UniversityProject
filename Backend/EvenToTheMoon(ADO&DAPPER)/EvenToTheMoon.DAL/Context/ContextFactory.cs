...
namespace EvenToTheMoon.DAL.Context
{
    public class ContextFactory : IDesignTimeDbContextFactory<EvenToTheMoonDBContext>
    {
        public EvenToTheMoonDBContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseSqlServer("Server=DESKTOP-7OJO846\\SQLEXPRESS; Database=EvenToTheMoonDapper;Integrated Security=True;");
